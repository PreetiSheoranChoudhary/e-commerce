...
function NavItems() {
    return (
        <div className="items-center justify-between w-full md:flex md:w-auto" id="nav-items">
            <ul className="flex flex-col p-4 md:p-o mt-4 font-medium border border-gray-100 rounded-lg md:flex-row md:mt-0 md:space-x-4 md:space-y-0 md:border-0 bg-white">
